  ...
  <div>
    ...
    <mdb-card class="card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg)">
      <div class="text-white text-center py-5 px-4 my-5">
        <div>
          <h2 class="card-title h1-responsive pt-3 mb-5 font-bold"><strong>The top one tivoli employer!</strong></h2>
          <p class="mx-5 mb-5">Make an account to submit your application TODAY!
          </p>
          <mdb-btn outline="white" size="md" icon="clone">Sign up</mdb-btn>
        </div>
      </div>
    </mdb-card>
    <!-- The main container in this component -->
    <mdb-container>
